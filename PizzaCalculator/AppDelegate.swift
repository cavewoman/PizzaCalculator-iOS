...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  func applicationDidEnterBackground(_ application: UIApplication) {
    ...
    let pizzaSuccess = pizzaStore.saveChanges()
    if (pizzaSuccess) {
      print("Saved all of the pizzas")
    } else {
      print("Could not save any of the pizzas")
    }
  }
  ...
  lazy var persistentContainer: NSPersistentContainer = {
      ...
      */
      let container = NSPersistentContainer(name: "PizzaCalculator")
